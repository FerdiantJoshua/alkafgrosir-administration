...
class ModelsTest(TestCase):
    def test_model_creation(self):
        ...
        products.append(Product.objects.get_or_create(code='S1108.HD1674.17', name='HD1674', color='Biru Baby', size='30x70', stock=100)[0])
        products.append(Product.objects.get_or_create(code='S1108.HD1674.03', name='HD1674', color='Pink Baby', size='30x70', stock=100)[0])
        products.append(Product.objects.get_or_create(code='S1105.HD122-25', name='HD122', color='Putih', size='30x70', stock=100)[0])
